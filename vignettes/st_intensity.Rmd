...
First, we want to check the intensity by using an artificial point pattern. Therefore, we simulate a spatio-temporal point pattern (in this case we fix the number of points prior to simulation).
...
Then we set a covariance model for the underlying random field, in our case we chose a Geneiting covariance with its own parameters. We set the additional parameters for the ramdom field simulation as the mesh 

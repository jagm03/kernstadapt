...
Then we set a covariance model for the underlying random field; in our case, we chose a Geneiting covariance with its parameters. We set the additional parameters for the random field simulation as the mesh, variance and scales.

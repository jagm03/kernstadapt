...
vignette: >
  %\VignetteIndexEntry{adaptive_temporal_intensity}
...
adapt.dens <- dens.t.bin(y1, at = "bins", dimt = 512)
true.dens <- Nt * dt(classic.dens$x, Inf)
...
# Adaptive intensity
adapt.dens <- dens.t.bin(y, bw = bw1, at = "bins", dimt = 512)
